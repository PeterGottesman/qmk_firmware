...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QW] = LAYOUT_60_ansi( \
    ...
    OSL(_FL), KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS, \
    ...
    KC_LCTL,  KC_LGUI, KC_LALT,                   KC_SPC,                                      KC_RCTRL,KC_RGUI, KC_RALT, OSL(_FL2) \
  ),
  ...
  [_FL] = LAYOUT_60_ansi(
    ...
    _______, _______, KC_UP,   _______, _______, _______, _______, _______, KC_TAB,  _______, _______, _______, _______, KC_PSCR, \
    KC_CAPS, KC_L, KC_D, KC_R, _______, _______, _______, _______, _______, _______, _______, _______,                   _______, \
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                   _______, \
    _______, _______, _______,                   KC_TILDE,                                    _______, _______, _______, _______  \
  ),
  ...
  // TODO: THIS
  [_FL2] = LAYOUT_60_ansi_split_rshift( \
